...
/**
 * A VERY INSECURE SSL trait implementation,
 * which disables all SSL verifications.
 * This is for testing and workaround only,
 * DO NOT USE IN PRODUCTION!!!
 */
class InsecureBearSSLTraits : public TransportTraits
{
public:
    InsecureBearSSLTraits()
    {
    }
...
bool HTTPClient::begin(String url, bool httpsNoVerify)
{
    // Assume HTTP
    if (!httpsNoVerify) {
        return begin(url);
    ...
    _transportTraits = TransportTraitsPtr(new InsecureBearSSLTraits());
    return true;
}
